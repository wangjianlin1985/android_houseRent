...
public class HourseTypeDetailActivity extends Activity {
	// 声明返回按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.hoursetype_detail);
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("查看房屋类别详情");
		...
		btnReturn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				HourseTypeDetailActivity.this.finish();
			}
		}); 
		initViewData();
	}
	...
	private void initViewData() {
		...
		this.TV_typeId.setText(hourseType.getTypeId() + "");
		this.TV_typeName.setText(hourseType.getTypeName());
	} 
}
