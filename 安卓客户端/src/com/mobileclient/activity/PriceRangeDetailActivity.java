...
public class PriceRangeDetailActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TV_priceName = (TextView) findViewById(R.id.TV_priceName);
	...
	private void initViewData() {
		...
		this.TV_rangeId.setText(priceRange.getRangeId() + "");
		this.TV_priceName.setText(priceRange.getPriceName());
	} 
}
