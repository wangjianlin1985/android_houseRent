...
public class HourseAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.hourse_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加房屋信息");
		...
		iv_housePhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(HourseAddActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_hourseName.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "房屋名称输入不能为空!", Toast.LENGTH_LONG).show();
						ET_hourseName.setFocusable(true);
						ET_hourseName.requestFocus();
						return;	
					}
					hourse.setHourseName(ET_hourseName.getText().toString());
					if(hourse.getHousePhoto() != null) {
						//如果图片地址不为空，说明用户选择了图片，这时需要连接服务器上传图片
						HourseAddActivity.this.setTitle("正在上传图片，稍等...");
						String housePhoto = HttpUtil.uploadFile(hourse.getHousePhoto());
						HourseAddActivity.this.setTitle("图片上传完毕！");
						hourse.setHousePhoto(housePhoto);
					} else {
						hourse.setHousePhoto("upload/noimage.jpg");
					}
					/*验证获取面积*/ 
					if(ET_area.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "面积输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_price.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "租金(元/月)输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_louceng.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "楼层/总楼层输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_zhuangxiu.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "装修输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_caoxiang.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "朝向输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_madeYear.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "建筑年代输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_connectPerson.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "联系人输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_connectPhone.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_detail.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "详细信息输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(HourseAddActivity.this, "地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传房屋信息信息*/
					HourseAddActivity.this.setTitle("正在上传房屋信息信息，稍等...");
					String result = hourseService.AddHourse(hourse);
