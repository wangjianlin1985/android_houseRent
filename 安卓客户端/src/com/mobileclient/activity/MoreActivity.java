...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"房屋信息","房屋类别","求租信息","留言信息","新闻公告","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, HourseListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, HourseTypeListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, WantHourseInfoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
